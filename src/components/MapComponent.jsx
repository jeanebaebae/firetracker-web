...
{/*             <div className="absolute top-4 left-2 z-[1000]">
              <div className="flex items-center bg-white/70 px-3 py-1.5 rounded-xl">
                <img
                  src={logoImg}
                  className="w-auto h-7 object-contain opacity-70"
                />
              </div>
            </div> */}
